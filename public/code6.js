...
gdjs.padCode.asyncCallback13767044 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.padCode.asyncCallback13767044(runtimeScene, asyncObjectsList)));
}
}
